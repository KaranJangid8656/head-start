...
export const TestimonialsSection = () => {
	return (
		<section id="testimonials" className="py-16 bg-gradient-to-br from-gray-300 via-gray-400 to-gray-500">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-12">
					<h2 className="text-4xl font-bold text-gray-900 mb-4">Critical Acclaim</h2>
					<p className="text-xl text-gray-800 max-w-3xl mx-auto">What industry leaders are saying about HeadStart</p>
				</div>
				...
				<div className="grid md:grid-cols-2 gap-8">
					{testimonials.map((testimonial, index) => (
						<Card
							key={index}
							className="bg-gradient-to-br from-gray-100/90 to-gray-300/60 border-gray-400 hover:bg-gray-200 transition-colors group backdrop-blur-sm"
						>
							<CardContent className="p-6">
								<div className="flex items-start mb-4">
									<Quote className="w-8 h-8 text-orange-400 mr-3 flex-shrink-0" />
								...
								<p className="text-gray-900 text-lg leading-relaxed mb-6 italic">"{testimonial.quote}"</p>
								<div>
