...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800">
      {/* CTA Section */}
      <div className="py-16 bg-gradient-to-r from-teal-600 to-orange-500">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Button size="lg" className="bg-white text-teal-600 hover:bg-gray-100 px-8 py-3 text-lg font-semibold group">
            Get Your Copy Now
